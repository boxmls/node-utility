...
Object.defineProperties( module.exports, {
  ...
  getReferrer: {
    ...
    value: function getReferrer( req, params, callback ) {
      ...
      let uri = referer || origin || ( 'http://' + host );
      ...
      myCache.get(cacheKey, function (err, urlParts) {
        ...
        firestore.listDocuments('brands', (err, brands)=>{
          ...
          urlParts.agentSubdomain = agentSubdomain.length && agentSubdomain[0].length && config.rules.reservedSubdomains.indexOf( agentSubdomain[0] ) < 0 ? agentSubdomain[0] : false;
