...
module.exports = (function ( self ) {
  ...
  self.formatAddress = function formatAddress( address ) {
    ...
    if( typeof address.streetNum !== 'undefined' && address.streetNum ) {
      value += address.streetNum;
    }

    if( typeof address.streetNumModifier !== 'undefined' && address.streetNumModifier ) {
      value += '-' + address.streetNumModifier;
    }

    if( typeof address.streetName !== 'undefined' && address.streetName ) {
      value += ' ' + address.streetName;
    }

    if( typeof address.streetSuffix !== 'undefined' && address.streetSuffix ) {
      value += ' ' + address.streetSuffix;
    }

    if( typeof address.unitNum !== 'undefined' && address.unitNum ) {
